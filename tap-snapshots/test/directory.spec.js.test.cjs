...
[ 
{"source":"test/pug/adam.pug","name":"html","type":"tag","lineNumber": 1, "children":[ 
  {"source":"test/pug/adam.pug","type":"unbuf_code","val":"var i = 1","lineNumber": 2},  
  {"source":"test/pug/adam.pug","type":"unbuf_code","val":"var j = 2","lineNumber": 3},  
  {"source":"test/pug/adam.pug","name":"p","type":"tag","assignment":true,"assignment_val":"i","lineNumber": 4}] 
},  
{"source":"test/pug/adam.pug","name":"body","type":"tag","lineNumber": 5}]
`
...
{"source":"test/pug/attrs.pug","type":"comment","val":"- foo(abc","lineNumber": 25},  
{"source":"test/pug/attrs.pug","type":"comment","val":"-    ,def)","lineNumber": 26},  
{"source":"test/pug/attrs.pug","type":"comment","val":"- foo(abc,","lineNumber": 27},  
{"source":"test/pug/attrs.pug","type":"comment","val":"-     def)","lineNumber": 28},  
{"source":"test/pug/attrs.pug","type":"comment","val":"- foo(abc,","lineNumber": 29},  
{"source":"test/pug/attrs.pug","type":"comment","val":"- \\t\\tdef)","lineNumber": 30},  
{"source":"test/pug/attrs.pug","type":"comment","val":"- foo(abc","lineNumber": 31},  
{"source":"test/pug/attrs.pug","type":"comment","val":"- \\t\\t,def)","lineNumber": 32},  
{"source":"test/pug/attrs.pug","type":"comment","val":"- foo(abc","lineNumber": 33},  
{"source":"test/pug/attrs.pug","type":"comment","val":"- \\t\\tdef)","lineNumber": 34},  
{"source":"test/pug/attrs.pug","type":"comment","val":"- foo(abc","lineNumber": 35},  
{"source":"test/pug/attrs.pug","type":"comment","val":"-     def)","lineNumber": 36},  
...
{"source":"test/pug/attrs.pug","type":"comment","val":"- a(foo='foo' bar='bar')","lineNumber": 43}]
`
...
{"source":"test/pug/block-expansion.pug","name":"ul","type":"tag","lineNumber": 1, "children":[ 
  {"source":"test/pug/block-expansion.pug","name":"li","type":"tag","lineNumber": 2, "children":[{"name":"a","type":"tag","attrs":[{"name":"href","val":"'#'"}],"val":"foo","state":"TEXT"}]},  
  {"source":"test/pug/block-expansion.pug","name":"li","type":"tag","lineNumber": 3, "children":[{"name":"a","type":"tag","attrs":[{"name":"href","val":"'#'"}],"val":"bar","state":"TEXT"}]}] 
},  
...
{"source":"test/pug/block-expansion.shorthands.pug","name":"ul","type":"tag","lineNumber": 1, "children":[ 
  {"source":"test/pug/block-expansion.shorthands.pug","name":"li","type":"tag","attrs":[{"name":"class","val":"\\"list-item\\""}],"lineNumber": 2, "children":[{"type":"tag","attrs":[{"name":"class","val":"\\"foo\\""}],"state":"NESTED","children":[{"type":"tag","id":"bar","val":"baz","state":"TEXT"}]}]}]}]
`
...
{"source":"test/pug/blocks-in-blocks.pug","type":"block","val":"body","lineNumber": 3, "children":[ 
  {"source":"test/pug/blocks-in-blocks.pug","type":"text","val":"h1 Page 2","lineNumber": 4}]}]
`
...
[ 
{"source":"test/pug/blocks-in-if.pug","type":"comment","val":"- see https://github.com/pugjs/pug/issues/1589","lineNumber": 1},  
...
{"source":"test/pug/blocks-in-if.pug","type":"unbuf_code","val":"if( ajax )","lineNumber": 5, "children":[ 
  {"source":"test/pug/blocks-in-if.pug","type":"comment","val":"- return only contents if ajax requests","lineNumber": 6},  
  {"source":"test/pug/blocks-in-if.pug","type":"block","val":"contents","lineNumber": 7, "children":[ 
    {"source":"test/pug/blocks-in-if.pug","type":"text","val":"p ajax contents","lineNumber": 8}]}] 
},  
{"source":"test/pug/blocks-in-if.pug","type":"unbuf_code","val":"else","lineNumber": 10, "children":[ 
  {"source":"test/pug/blocks-in-if.pug","type":"comment","val":"- return all html","lineNumber": 11},  
    ...
    {"source":"test/pug/blocks-in-if.pug","name":"head","type":"tag","lineNumber": 14, "children":[ 
      ...
      {"source":"test/pug/blocks-in-if.pug","name":"body","type":"tag","lineNumber": 17, "children":[ 
        {"source":"test/pug/blocks-in-if.pug","type":"block","val":"contents","lineNumber": 18, "children":[ 
          {"source":"test/pug/blocks-in-if.pug","type":"text","val":"p all contetns","lineNumber": 19}]}]}]}]}]}]
`
...
{"source":"test/pug/case-blocks.pug","name":"html","type":"tag","lineNumber": 1, "children":[ 
  {"source":"test/pug/case-blocks.pug","name":"body","type":"tag","lineNumber": 2, "children":[ 
    ...
    {"source":"test/pug/case-blocks.pug","type":"case","val":"friends","lineNumber": 4, "children":[ 
      {"source":"test/pug/case-blocks.pug","type":"text","val":"when 0","lineNumber": 5, "children":[ 
        {"source":"test/pug/case-blocks.pug","type":"text","val":"p you have no friends","lineNumber": 6}] 
},  
      {"source":"test/pug/case-blocks.pug","type":"when","val":"1","lineNumber": 7, "children":[ 
        {"source":"test/pug/case-blocks.pug","type":"text","val":"p you have a friend","lineNumber": 8}] 
},  
...
{"source":"test/pug/case.pug","name":"html","type":"tag","lineNumber": 1, "children":[ 
  {"source":"test/pug/case.pug","name":"body","type":"tag","lineNumber": 2, "children":[ 
    ...
    {"source":"test/pug/case.pug","type":"case","val":"friends","lineNumber": 4, "children":[ 
      {"source":"test/pug/case.pug","type":"text","val":"when 0: p you have no friends","lineNumber": 5},  
    ...
    {"source":"test/pug/case.pug","type":"case","val":"friends","lineNumber": 9, "children":[ 
      {"source":"test/pug/case.pug","type":"text","val":"when 0","lineNumber": 10},  
      {"source":"test/pug/case.pug","type":"when","val":"1","lineNumber": 11, "children":[ 
        {"source":"test/pug/case.pug","type":"text","val":"p you have very few friends","lineNumber": 12}] 
},  
    ...
    {"source":"test/pug/case.pug","type":"case","val":"friend","lineNumber": 17, "children":[ 
      {"source":"test/pug/case.pug","type":"text","val":"when 'Tim:G':    p Friend is a string","lineNumber": 18},  
...
{"source":"test/pug/code.conditionals.pug","type":"if","val":"true","lineNumber": 13, "children":[ 
  {"source":"test/pug/code.conditionals.pug","type":"text","val":"p foo","lineNumber": 14},  
...
{"source":"test/pug/code.conditionals.pug","type":"unless","val":"true","lineNumber": 20, "children":[ 
  {"source":"test/pug/code.conditionals.pug","type":"text","val":"p foo","lineNumber": 21}] 
},  
...
{"source":"test/pug/code.conditionals.pug","type":"if","val":"'nested'","lineNumber": 25, "children":[ 
  {"source":"test/pug/code.conditionals.pug","type":"text","val":"if 'works'","lineNumber": 26, "children":[ 
    {"source":"test/pug/code.conditionals.pug","type":"text","val":"p yay","lineNumber": 27}]}] 
},  
{"source":"test/pug/code.conditionals.pug","type":"comment","val":"- allow empty blocks","lineNumber": 29},  
...
{"source":"test/pug/code.conditionals.pug","type":"if","val":"true","lineNumber": 33, "children":[ 
  {"source":"test/pug/code.conditionals.pug","type":"text","val":".bar","lineNumber": 34}] 
},  
...
{"source":"test/pug/code.conditionals.pug","type":"if","val":"false","lineNumber": 38, "children":[ 
  {"source":"test/pug/code.conditionals.pug","type":"text","val":".bing","lineNumber": 39}] 
},  
{"source":"test/pug/code.conditionals.pug","type":"else","val":"if false","lineNumber": 40, "children":[ 
  {"source":"test/pug/code.conditionals.pug","type":"text","val":".bar","lineNumber": 41}] 
},  
...
{"source":"test/pug/code.iteration.pug","name":"ul","type":"tag","lineNumber": 11, "children":[ 
  {"source":"test/pug/code.iteration.pug","type":"for","val":"item, i in items","lineNumber": 12, "children":[ 
    {"source":"test/pug/code.iteration.pug","type":"text","val":"li(class='item-' + i)= item","lineNumber": 13}]}] 
},  
{"source":"test/pug/code.iteration.pug","name":"ul","type":"tag","lineNumber": 15, "children":[ 
  {"source":"test/pug/code.iteration.pug","type":"each","val":"item, i in items","lineNumber": 16, "children":[ 
    {"source":"test/pug/code.iteration.pug","type":"text","val":"li= item","lineNumber": 17}]}] 
},  
{"source":"test/pug/code.iteration.pug","name":"ul","type":"tag","lineNumber": 19, "children":[ 
  {"source":"test/pug/code.iteration.pug","type":"each","val":"$item in items","lineNumber": 20, "children":[ 
    {"source":"test/pug/code.iteration.pug","type":"text","val":"li= $item","lineNumber": 21}]}] 
},  
...
{"source":"test/pug/code.iteration.pug","name":"ul","type":"tag","lineNumber": 26, "children":[ 
  {"source":"test/pug/code.iteration.pug","type":"for","val":"l in letters","lineNumber": 27, "children":[ 
    {"source":"test/pug/code.iteration.pug","type":"text","val":"for n in nums","lineNumber": 28, "children":[ 
      {"source":"test/pug/code.iteration.pug","type":"text","val":"li #{n}: #{l}","lineNumber": 29}]}]}] 
},  
...
{"source":"test/pug/code.iteration.pug","name":"ul","type":"tag","lineNumber": 33, "children":[ 
  {"source":"test/pug/code.iteration.pug","type":"for","val":"n in counter()","lineNumber": 34, "children":[ 
    {"source":"test/pug/code.iteration.pug","type":"text","val":"li #{n}","lineNumber": 35}]}]}]
`
...
{"source":"test/pug/comments-in-case.pug","name":"html","type":"tag","lineNumber": 2, "children":[ 
  ...
  {"source":"test/pug/comments-in-case.pug","type":"case","val":"s","lineNumber": 5, "children":[ 
    {"source":"test/pug/comments-in-case.pug","type":"text","val":"//- Comment","lineNumber": 6},  
    {"source":"test/pug/comments-in-case.pug","type":"when","val":"'this'","lineNumber": 7, "children":[ 
      {"source":"test/pug/comments-in-case.pug","type":"text","val":"p It's this!","lineNumber": 8}] 
},  
    {"source":"test/pug/comments-in-case.pug","type":"when","val":"'that'","lineNumber": 9, "children":[ 
      {"source":"test/pug/comments-in-case.pug","type":"text","val":"p It's that!","lineNumber": 10}]}]}]}]
`
...
{"source":"test/pug/each.else.pug","name":"ul","type":"tag","lineNumber": 4, "children":[ 
  {"source":"test/pug/each.else.pug","type":"for","val":"user in users","lineNumber": 5, "children":[ 
    {"source":"test/pug/each.else.pug","type":"text","val":"li= user.name","lineNumber": 6}] 
},  
...
{"source":"test/pug/each.else.pug","type":"if","val":"users","lineNumber": 13, "children":[ 
  {"source":"test/pug/each.else.pug","type":"text","val":"ul","lineNumber": 14, "children":[ 
    {"source":"test/pug/each.else.pug","type":"text","val":"for user in users","lineNumber": 15, "children":[ 
      {"source":"test/pug/each.else.pug","type":"text","val":"li= user.name","lineNumber": 16}] 
},  
...
{"source":"test/pug/each.else.pug","name":"ul","type":"tag","lineNumber": 22, "children":[ 
  {"source":"test/pug/each.else.pug","type":"each","val":"val, key in user","lineNumber": 23, "children":[ 
    {"source":"test/pug/each.else.pug","type":"text","val":"li #{key}: #{val}","lineNumber": 24}] 
},  
...
{"source":"test/pug/each.else.pug","name":"ul","type":"tag","lineNumber": 30, "children":[ 
  {"source":"test/pug/each.else.pug","type":"each","val":"prop, key in user","lineNumber": 31, "children":[ 
    {"source":"test/pug/each.else.pug","type":"text","val":"li #{key}: #{val}","lineNumber": 32}] 
},  
...
{"source":"test/pug/each.else.pug","name":"ul","type":"tag","lineNumber": 39, "children":[ 
  {"source":"test/pug/each.else.pug","type":"each","val":"val, key in user","lineNumber": 40, "children":[ 
    {"source":"test/pug/each.else.pug","type":"text","val":"li #{key}: #{val}","lineNumber": 41}] 
},  
...
{"source":"test/pug/each.else.pug","name":"ul","type":"tag","lineNumber": 46, "children":[ 
  {"source":"test/pug/each.else.pug","type":"each","val":"val of ofKeyword","lineNumber": 47, "children":[ 
    {"source":"test/pug/each.else.pug","type":"text","val":"li= user.name","lineNumber": 48}]}] 
},  
{"source":"test/pug/each.else.pug","name":"ul","type":"tag","lineNumber": 50, "children":[ 
  {"source":"test/pug/each.else.pug","type":"each","val":"val of [\\"variable with of keyword\\"]","lineNumber": 51, "children":[ 
    {"source":"test/pug/each.else.pug","type":"text","val":"li= val","lineNumber": 52}]}]}]
`
...
exports[`test/directory.spec.js TAP test directory testing file=filters-empty.pug > File /Users/aakoch/projects/new-foo/workspaces/pug-lexing-transformer/test/pug/filters-empty.pug did not match snapshot 1`] = `
[ 
{"source":"test/pug/filters-empty.pug","type":"unbuf_code","val":"var users = [{ name: 'tobi', age: 2 }]","lineNumber": 1},  
{"source":"test/pug/filters-empty.pug","name":"fb","type":"tag","val":":users","lineNumber": 3, "children":[ 
  {"source":"test/pug/filters-empty.pug","type":"text","val":"for user in users","lineNumber": 4, "children":[ 
    {"source":"test/pug/filters-empty.pug","type":"text","val":"fb:user(age=user.age)","lineNumber": 5, "children":[ 
      {"source":"test/pug/filters-empty.pug","type":"text","val":":cdata","lineNumber": 6}]}]}]}]
`
...
{"source":"test/pug/html.pug","name":"p","type":"tag","lineNumber": 13, "children":[{"type":"text","val":"<strong>Even</strong> as the body of a block expansion.","state":"TEXT"}]}]
`
  ...
  {"source":"test/pug/include-only-text.pug","name":"body","type":"tag","lineNumber": 2, "children":[ 
    {"source":"test/pug/include-only-text.pug","name":"p","type":"tag","lineNumber": 3, "children":[ 
      {"source":"test/pug/include-only-text.pug","type":"include","val":"include-only-text-body.pug","lineNumber": 4, "children":[ 
        {"source":"test/pug/include-only-text.pug","type":"text","val":"em hello world","lineNumber": 5}]}]}]}]}]
`
...
{"source":"test/pug/include-with-text.pug","name":"html","type":"tag","lineNumber": 1, "children":[ 
  {"source":"test/pug/include-with-text.pug","type":"include","val":"include-with-text-head.pug","lineNumber": 2, "children":[ 
    {"source":"test/pug/include-with-text.pug","type":"text","val":"script(src='/caustic.js')","lineNumber": 3},  
...
{"source":"test/pug/include.yield.nested.pug","type":"include","val":"auxiliary/yield-nested.pug","lineNumber": 2, "children":[ 
  {"source":"test/pug/include.yield.nested.pug","type":"text","val":"p some content","lineNumber": 3},  
...
{"source":"test/pug/inheritance.alert-dialog.pug","type":"block","val":"content","lineNumber": 4, "children":[ 
  {"source":"test/pug/inheritance.alert-dialog.pug","type":"text","val":"h1 Alert!","lineNumber": 5},  
...
{"source":"test/pug/inheritance.defaults.pug","name":"html","type":"tag","lineNumber": 1, "children":[ 
  {"source":"test/pug/inheritance.defaults.pug","name":"head","type":"tag","lineNumber": 2, "children":[ 
    {"source":"test/pug/inheritance.defaults.pug","type":"block","val":"head","lineNumber": 3, "children":[ 
      {"source":"test/pug/inheritance.defaults.pug","type":"text","val":"script(src='jquery.js')","lineNumber": 4},  
...
{"source":"test/pug/inheritance.extend.recursive.pug","type":"block","val":"parent","lineNumber": 3, "children":[ 
  {"source":"test/pug/inheritance.extend.recursive.pug","type":"text","val":"h4 child","lineNumber": 4}]}]
`
...
{"source":"test/pug/inheritance.pug","type":"block","val":"head","lineNumber": 4, "children":[ 
  {"source":"test/pug/inheritance.pug","type":"text","val":"script(src='jquery.js')","lineNumber": 5}] 
},  
{"source":"test/pug/inheritance.pug","type":"block","val":"content","lineNumber": 7, "children":[ 
  {"source":"test/pug/inheritance.pug","type":"text","val":"h2 Page","lineNumber": 8},  
...
[ 
{"source":"test/pug/intepolated-elements.pug","name":"p","type":"tag","children":[{"name":"a","type":"tag","attrs":[{"name":"class","val":"\\"rho\\""},{"name":"href","val":"'#'"},{"name":"class","val":"'rho--modifier'"}],"val":"with inline link","state":"TEXT"}],"lineNumber": 1},  
...
{"source":"test/pug/intepolated-elements.pug","name":"p","type":"tag","children":[{"type":"text","val":"Some text "},{"name":"a","type":"tag","attrs":[{"name":"class","val":"\\"rho\\""},{"name":"href","val":"'#'"},{"name":"class","val":"'rho--modifier'"}],"val":"with inline link","state":"TEXT"}],"lineNumber": 3}]
`
...
{"source":"test/pug/interpolated-mixin.pug","type":"mixin","val":"linkit(url)","lineNumber": 1, "children":[ 
  {"source":"test/pug/interpolated-mixin.pug","type":"text","val":"a(href=url)= url","lineNumber": 2}] 
},  
...
{"source":"test/pug/layout.append.pug","type":"block","val":"append head","lineNumber": 4, "children":[ 
  {"source":"test/pug/layout.append.pug","type":"text","val":"script(src='foo.js')","lineNumber": 5},  
...
{"source":"test/pug/layout.append.without-block.pug","type":"append","val":"head","lineNumber": 4, "children":[ 
  {"source":"test/pug/layout.append.without-block.pug","type":"text","val":"script(src='foo.js')","lineNumber": 5},  
...
{"source":"test/pug/layout.multi.append.prepend.block.pug","type":"append","val":"content","lineNumber": 3, "children":[ 
  {"source":"test/pug/layout.multi.append.prepend.block.pug","type":"text","val":"p.first.append Something appended to content","lineNumber": 4}] 
},  
{"source":"test/pug/layout.multi.append.prepend.block.pug","type":"prepend","val":"content","lineNumber": 6, "children":[ 
  {"source":"test/pug/layout.multi.append.prepend.block.pug","type":"text","val":"p.first.prepend Something prepended to content","lineNumber": 7}] 
},  
{"source":"test/pug/layout.multi.append.prepend.block.pug","type":"append","val":"content","lineNumber": 9, "children":[ 
  {"source":"test/pug/layout.multi.append.prepend.block.pug","type":"text","val":"p.last.append Last append must be most last","lineNumber": 10}] 
},  
{"source":"test/pug/layout.multi.append.prepend.block.pug","type":"prepend","val":"content","lineNumber": 12, "children":[ 
  {"source":"test/pug/layout.multi.append.prepend.block.pug","type":"text","val":"p.last.prepend Last prepend must appear at top","lineNumber": 13}] 
},  
{"source":"test/pug/layout.multi.append.prepend.block.pug","type":"append","val":"head","lineNumber": 15, "children":[ 
  {"source":"test/pug/layout.multi.append.prepend.block.pug","type":"text","val":"script(src='jquery.js')","lineNumber": 16}] 
},  
{"source":"test/pug/layout.multi.append.prepend.block.pug","type":"prepend","val":"head","lineNumber": 18, "children":[ 
  {"source":"test/pug/layout.multi.append.prepend.block.pug","type":"text","val":"script(src='foo.js')","lineNumber": 19}]}]
`
...
{"source":"test/pug/layout.prepend.pug","type":"block","val":"prepend head","lineNumber": 4, "children":[ 
  {"source":"test/pug/layout.prepend.pug","type":"text","val":"script(src='foo.js')","lineNumber": 5},  
...
{"source":"test/pug/layout.prepend.without-block.pug","type":"prepend","val":"head","lineNumber": 4, "children":[ 
  {"source":"test/pug/layout.prepend.without-block.pug","type":"text","val":"script(src='foo.js')","lineNumber": 5},  
...
{"source":"test/pug/mixin-block-with-space.pug","type":"mixin","val":"m(id)","lineNumber": 1, "children":[ 
  {"source":"test/pug/mixin-block-with-space.pug","type":"text","val":"div","lineNumber": 2, "children":[ 
    {"source":"test/pug/mixin-block-with-space.pug","type":"text","val":"block    ","lineNumber": 3}]}] 
},  
...
{"source":"test/pug/mixin-hoist.pug","type":"mixin","val":"foo()","lineNumber": 2, "children":[ 
  {"source":"test/pug/mixin-hoist.pug","type":"text","val":"h1= title","lineNumber": 3}] 
},  
...
[ 
{"source":"test/pug/mixin-via-include.pug","type":"comment","val":"- regression test for https://github.com/pugjs/pug/issues/1435","lineNumber": 1},  
...
{"source":"test/pug/mixins-unused.pug","type":"mixin","val":"never-called","lineNumber": 1, "children":[ 
  {"source":"test/pug/mixins-unused.pug","type":"text","val":".wtf This isn't something we ever want to output","lineNumber": 2}] 
},  
...
{"source":"test/pug/mixins.rest-args.pug","type":"mixin","val":"list(tag, ...items)","lineNumber": 1, "children":[ 
  {"source":"test/pug/mixins.rest-args.pug","type":"text","val":"#{tag}","lineNumber": 2, "children":[ 
    {"source":"test/pug/mixins.rest-args.pug","type":"text","val":"each item in items","lineNumber": 3, "children":[ 
      {"source":"test/pug/mixins.rest-args.pug","type":"text","val":"li= item","lineNumber": 4}]}]}] 
},  
...
[ 
{"source":"test/pug/pipeless-comments.pug","type":"comment","lineNumber": 1, "children":[ 
...
{"source":"test/pug/regression.1794.pug","type":"block","val":"content","lineNumber": 3, "children":[ 
  {"source":"test/pug/regression.1794.pug","type":"text","val":"include ./auxiliary/1794-include.pug","lineNumber": 4}]}]
`
...
{"source":"test/pug/tag.interpolation.pug","type":"mixin","val":"item(icon)","lineNumber": 9, "children":[ 
  {"source":"test/pug/tag.interpolation.pug","type":"text","val":"li","lineNumber": 10, "children":[ 
    {"source":"test/pug/tag.interpolation.pug","type":"text","val":"if attributes.href","lineNumber": 11, "children":[ 
      {"source":"test/pug/tag.interpolation.pug","type":"text","val":"a&attributes(attributes)","lineNumber": 12, "children":[ 
        {"source":"test/pug/tag.interpolation.pug","type":"text","val":"img.icon(src=icon)","lineNumber": 13},  
...
{"source":"test/pug/template.pug","name":"script","type":"tag","attrs":[{"name":"type","val":"'text/x-template'"}],"lineNumber": 6, "children":[ 
  {"source":"test/pug/template.pug","type":"text","val":"article","lineNumber": 7, "children":[ 
    ...
    {"source":"test/pug/template.pug","name":"p","type":"tag","val":"{{description}}","lineNumber": 9}]}]}]
`
...
{"source":"test/pug/text-block.pug","name":"label","type":"tag","val":"Username:","lineNumber": 2, "children":[ 
  {"source":"test/pug/text-block.pug","type":"text","val":"input(type='text', name='user[name]')","lineNumber": 3}] 
},  
{"source":"test/pug/text-block.pug","name":"label","type":"tag","val":"Password:","lineNumber": 5, "children":[ 
  {"source":"test/pug/text-block.pug","type":"text","val":"input(type='text', name='user[pass]')","lineNumber": 6}]}]
`
...
{"source":"test/pug/while.pug","name":"ul","type":"tag","lineNumber": 2, "children":[ 
  {"source":"test/pug/while.pug","type":"while","val":"x < 10","lineNumber": 3, "children":[ 
    {"source":"test/pug/while.pug","type":"text","val":"- x++;","lineNumber": 4},  
...
{"source":"test/pug/yield-before-conditional-head.pug","name":"head","type":"tag","lineNumber": 1, "children":[ 
  ...
  {"source":"test/pug/yield-before-conditional-head.pug","type":"if","val":"false","lineNumber": 4, "children":[ 
    {"source":"test/pug/yield-before-conditional-head.pug","type":"text","val":"script(src='/jquery.ui.js')","lineNumber": 5}]}]}]
`
...
{"source":"test/pug/yield-before-conditional.pug","name":"html","type":"tag","lineNumber": 1, "children":[ 
  {"source":"test/pug/yield-before-conditional.pug","name":"body","type":"tag","lineNumber": 2, "children":[ 
    {"source":"test/pug/yield-before-conditional.pug","type":"include","val":"yield-before-conditional-head.pug","lineNumber": 3, "children":[ 
      {"source":"test/pug/yield-before-conditional.pug","type":"text","val":"script(src='/caustic.js')","lineNumber": 4},  
...
{"source":"test/pug/yield.pug","name":"html","type":"tag","lineNumber": 1, "children":[ 
  {"source":"test/pug/yield.pug","name":"body","type":"tag","lineNumber": 2, "children":[ 
    {"source":"test/pug/yield.pug","type":"include","val":"yield-head.pug","lineNumber": 3, "children":[ 
      {"source":"test/pug/yield.pug","type":"text","val":"script(src='/caustic.js')","lineNumber": 4},  
