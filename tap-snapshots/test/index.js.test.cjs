 ...
 */
'use strict'
exports[`test/index.js TAP test basic file with snapshot > File /Users/aakoch/projects/new-foo/workspaces/pug-lexing-transformer/test/pug/basic.pug did not match snapshot 1`] = `
[ 
